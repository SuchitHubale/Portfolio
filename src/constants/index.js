...
export const expCards = [
  {
    review:
      "I thoroughly enjoyed working on the AI Fusion event website. I focused on building a fast, responsive, and visually appealing platform that made event registration and management easy for users.",
  ...
  {
    review:
      "Built a federated learning system for fraud detection, enabling secure, distributed model training across multiple clients with real-time monitoring.",
  ...
  {
    review:
      "Their work on the Mock Interview Prep app delivered a robust, user-friendly platform for technical interview practice, integrating real-time feedback and modern authentication.",
...
export const socialImgs = [
  ...
  },
  {
    ...
    url: "https://x.com/suchithubale?s=11",
  },
  {
    name: "linkedin",
    imgPath: "/images/linkedin.png",
    url: "https://www.linkedin.com/in/suchit-hubale-40a920256/",
  },
];
...
export const projects = [
  {
    ...
    subtitle:
      "A full-stack web application for simulating technical and behavioral interviews with AI-driven feedback and analytics.",
    ...
    about:
      "SSH Mock Interview Prep is a modern web platform that allows users to practice technical, behavioral, and mixed interviews in a realistic environment. Users can select roles, tech stacks, and interview types, receive AI-generated questions, and get instant feedback and scoring. The platform supports user authentication, profile management, and detailed analytics to help users track their progress.",
    problemStatement:
      "Preparing for technical interviews can be daunting due to lack of realistic practice and actionable feedback. The goal was to create an interactive platform where users can simulate real interview scenarios, receive AI-driven feedback, and monitor their improvement over time.",
    keyChallenges: [
    ...
    projectTimeline:
      "The project was completed over two months: the first month focused on core interview logic and authentication, while the second month was dedicated to AI integration, analytics, and UI/UX refinement.",
    systemArchitecture: {
      overview:
        "Full-stack web application with serverless backend and AI integration",
...
Analytics Dashboard
    ...
    milestones: [
      {
        ...
        description:
          "Set up Next.js project, implemented authentication, and designed the interview flow.",
        date: "Week 1-2",
        status: "completed",
        icon: "system",
      },
      {
        ...
        description:
          "Integrated VAPI for AI-driven question generation and feedback scoring.",
        date: "Week 3-4",
        status: "completed",
        icon: "ai",
      },
      {
        ...
        description:
          "Built analytics dashboard, profile management, and interview history features.",
        date: "Week 5-6",
        status: "completed",
        icon: "dashboard",
      },
      {
        ...
        description:
          "Refined UI/UX with Tailwind CSS and deployed the app to Vercel.",
        date: "Week 7-8",
        status: "completed",
        icon: "deploy",
      },
  ...
  {
    image: "/images/Fraude-pro2.png",
    title: "Fraud Detection System",
    subtitle:
      "A distributed machine learning system for fraud detection using federated learning with multiple clients and a central server.",
    handle: "Personal/Group Project",
    borderColor: "#4CAF50",
    gradient: "linear-gradient(135deg,#4CAF50,#2196F3)",
    url: "https://github.com/SuchitHubale/Federated-Learning-Bank-Fraud",
    technologies: [
      "Python",
      "PyTorch",
      "Flask",
    ...
    about:
      "This project implements a federated learning system for fraud detection in financial transactions. It enables multiple clients to collaboratively train a machine learning model without sharing their raw data, addressing privacy concerns while improving model performance through distributed learning.",
    problemStatement:
...
Central Server (Flask) <=> Client 1 (PyTorch)
    ...
    milestones: [
      {
        ...
        description:
          "In-depth research on federated learning algorithms, system architecture planning, and technology stack selection.",
        date: "Week 1-4",
        status: "completed",
        icon: "research",
      },
      {
        ...
        description:
          "Implementation of the central server, client models, and federated learning communication protocol.",
        date: "Week 5-8",
        status: "completed",
        icon: "system",
      },
      {
        ...
        description:
          "Building the Streamlit dashboard for real-time monitoring and model performance visualization.",
        date: "Week 9-10",
        status: "completed",
        icon: "dashboard",
      },
      {
        ...
        description:
          "Comprehensive testing of the federated learning system, performance optimization, and final deployment.",
        date: "Week 11-12",
        status: "completed",
        icon: "test",
      },
  ...
  },
  {
    ...
    subtitle:
      "A comprehensive event management platform for the Department of AIML featuring technical competitions, gaming events, and seamless registration with payment integration.",
    handle: "Client Project",
    borderColor: "#6366F1",
    gradient: "linear-gradient(135deg,#6366F1,#8B5CF6)",
    url: "https://github.com/SuchitHubale/AI-Fusion",
    technologies: [
      "React",
      "Firebase",
      "Tailwind CSS",
    ...
    projectTimeline:
      "The project was developed as an ongoing academic initiative for the Department of AIML. The initial phase focused on core functionality including event management and registration. The second phase added payment integration and admin features. The current phase involves continuous improvements and feature enhancements based on user feedback and event requirements.",
    systemArchitecture: {
      overview:
        "Modern event management platform with real-time capabilities and payment integration",
...
React Frontend <=> Firebase Services
    ...
    milestones: [
      {
        ...
        description:
          "Core functionality development including event management, registration system, and basic UI implementation.",
      ...
      },
      {
        ...
        description:
          "Integration of Razorpay payment gateway and implementation of secure payment processing.",
      ...
      },
      {
        ...
        description:
          "Building comprehensive admin dashboard with analytics, data export, and event management capabilities.",
      ...
      },
      {
        ...
        description:
          "Ongoing feature enhancements, performance optimization, and user experience improvements based on feedback.",
  ...
  {
    image: "/images/pataint-pro4.png",
    title: "BERT-Powered Patent Search Engine",
    subtitle:
      "An intelligent patent search engine using BERT-based semantic search for comprehensive patent discovery and analysis.",
    handle: "Academic Project",
    borderColor: "#4A90E2",
    gradient: "linear-gradient(135deg,#4A90E2,#2C3E50)",
    url: "N/A (academic project, not publicly available)",
    technologies: [
      "Python",
      "Flask",
      "BERT",
    ...
    about:
      "This project is an advanced patent search engine that leverages BERT-based semantic search to provide intelligent patent discovery capabilities. The system scrapes patent data from Google Patents, generates semantic embeddings using BERT, indexes them using FAISS for efficient similarity search, and provides a web interface for users to search through thousands of patent documents with high semantic relevance.",
    problemStatement:
      "The goal was to create a sophisticated patent search system that could understand the semantic meaning of search queries and find relevant patents even when they use different terminology. Traditional keyword-based search systems often miss relevant patents that use synonyms or different technical terms. This project addresses this limitation by implementing semantic search using BERT embeddings to understand context and meaning.",
    keyChallenges: [
    ...
    systemArchitecture: {
      overview:
        "AI-powered semantic search system with BERT embeddings and vector indexing",
...
User Query <=> Flask App <=> BERT Model
    ...
    milestones: [
      {
        ...
        description:
          "Development of Scrapy spider to collect patent data from Google Patents, processing 100,000+ documents.",
        date: "Month 1",
        status: "completed",
        icon: "data",
      },
      {
        ...
        description:
          "Implementation of BERT embeddings generation and FAISS indexing for efficient semantic search.",
        date: "Month 2",
        status: "completed",
        icon: "ai",
      },
      {
        ...
        description:
          "Development of responsive web interface, comprehensive testing, and system optimization.",
        date: "Month 3",
        status: "pending",
        icon: "web",
      },
  ...
  {
    image: "/images/Snippets-pro5.png",
    title: "Code Snippets Manager",
    subtitle:
      "A modern web application for managing and editing code snippets with a beautiful Monaco editor integration.",
    handle: "Personal Project",
    borderColor: "#6366F1",
    gradient: "linear-gradient(135deg,#6366F1,#38BDF8)",
    url: "https://github.com/SuchitHubale/Code-Snippets",
    technologies: [
      "Next.js",
      "React",
      "TypeScript",
    ...
    problemStatement:
      "Developers often struggle to keep their code snippets organized and accessible. This project aims to provide a seamless, beautiful, and efficient way to manage code snippets, making it easy to create, edit, and retrieve code for reuse.",
    keyChallenges: [
    ...
    technicalImplementation:
      "The application is built with Next.js and React for the frontend, using TypeScript for type safety. Prisma ORM manages the SQLite database, handling all CRUD operations for code snippets. The Monaco Editor provides a rich code editing experience. Tailwind CSS and Radix UI are used for styling and UI components. The app is structured with clear separation of concerns: server actions, components, and utility libraries.",
    projectTimeline:
      "The project was completed over two months: the first month focused on core CRUD logic and UI design, while the second month was dedicated to editor integration, form validation, and UX refinement.",
    systemArchitecture: {
      overview:
        "Full-stack web application with server-side rendering and database integration",
      frontend:
        "Next.js (React, TypeScript), Tailwind CSS, Radix UI, Monaco Editor",
    ...
    milestones: [
      {
        title: "Core Platform Development",
        description:
          "Set up Next.js project, implemented CRUD operations for snippets, and designed the main UI.",
        date: "Week 1-2",
        status: "completed",
        icon: "system",
      },
      {
        ...
        description:
          "Integrated Monaco Editor and implemented robust form validation.",
        date: "Week 3-4",
        status: "completed",
        icon: "ai",
      },
      {
        title: "UI/UX & Styling",
        description:
          "Refined UI/UX with Tailwind CSS, Radix UI, and added dark mode support.",
        date: "Week 5-6",
        status: "completed",
        icon: "dashboard",
      },
      {
        ...
        description:
          "Deployed the app to Vercel and wrote comprehensive documentation.",
        date: "Week 7-8",
        status: "completed",
        icon: "deploy",
      },
  ...
  {
    image: "/images/nike-pro6.png",
    title: "Nike Product Landing Page",
    subtitle:
      "A modern, responsive landing page for Nike shoes, featuring product highlights, customer reviews, and seamless user experience.",
    handle: "Personal Project",
    borderColor: "#FF6452",
    gradient: "linear-gradient(135deg,#FF6452,#F5F6FF)",
    url: "https://github.com/SuchitHubale/Nike-App",
    technologies: ["React", "Vite", "Tailwind CSS", "Framer Motion"],
    about:
      "Nike-App is a visually engaging, single-page React application designed to showcase Nike's latest shoe collections. The site features interactive product cards, customer testimonials, special offers, and a newsletter subscription form, all styled with Tailwind CSS and animated using Framer Motion for a premium user experience.",
    problemStatement:
      "Modern e-commerce brands need visually appealing, fast, and responsive landing pages to convert visitors into customers. The goal was to create a Nike-themed landing page that highlights products, builds trust with customer reviews, and encourages user engagement.",
    keyChallenges: [
      "Designing a visually striking and responsive layout for all devices",
      "Implementing smooth, interactive animations with Framer Motion",
      "Structuring reusable React components for scalability",
      "Ensuring accessibility and performance with Tailwind CSS",
    ],
    role: "Frontend Developer",
    category: "Web Application / E-commerce",
    featured: true,
    duration: "Apr 2024",
    liveDemo: "https://nike-app-xi-lac.vercel.app/",
    sourceCode: "https://github.com/SuchitHubale/Nike-App",
    keyFeatures: [
      "Hero section with animated Nike shoe highlights",
      "Popular products grid with interactive cards",
    ...
    technicalImplementation:
      "The app is built with React and Vite for fast development and hot module reloading. Tailwind CSS is used for utility-first, responsive styling, while Framer Motion powers the interactive animations. The project is structured with reusable components and organized sections for maintainability.",
    projectTimeline:
      "The project was completed in under a month: the first two weeks focused on layout and component development, followed by animation integration and responsive design refinement.",
    systemArchitecture: {
      overview:
        "Single-page React application with modular component structure",
      frontend: "React (Vite), Tailwind CSS, Framer Motion",
      backend: "None (static frontend)",
      aiIntegration: "None",
      dataStorage: "Static data (JS constants)",
      authentication: "None",
      monitoring: "N/A",
      deployment: "Vercel Hosting",
      diagram:
        "User <=> React Frontend (Vite, Tailwind, Framer Motion) <=> Static Assets",
    },
    milestones: [
      {
        title: "Layout & Component Structure",
        description:
          "Set up project with Vite, created main sections and reusable components.",
        date: "Week 1",
        status: "completed",
        icon: "system",
      },
      {
        ...
        description:
          "Implemented Tailwind CSS for responsive design and consistent branding.",
        date: "Week 2",
        status: "completed",
        icon: "style",
      },
      {
        ...
        description:
          "Integrated Framer Motion for smooth UI animations and interactive elements.",
        date: "Week 3",
        status: "completed",
        icon: "animation",
      },
      {
        title: "Final Touches & Deployment",
        description:
          "Polished UI, tested responsiveness, and deployed to static hosting.",
        date: "Week 4",
        status: "completed",
        icon: "deploy",
      },
